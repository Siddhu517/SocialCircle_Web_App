let Post,User,AWS,fs;_9e6‍.x([["profileImageUpdate",()=>profileImageUpdate],["profileBackImageUpdate",()=>profileBackImageUpdate],["uploadImages",()=>uploadImages],["uploadVideos",()=>uploadVideos],["uploadDocuments",()=>uploadDocuments],["deletePost",()=>deletePost]]);_9e6‍.w("../Models/post",[["default",["Post"],function(v){Post=v}]]);_9e6‍.w("../Models/user",[["default",["User"],function(v){User=v}]]);_9e6‍.w("aws-sdk",[["default",["AWS"],function(v){AWS=v}]]);_9e6‍.w("fs",[["default",["fs"],function(v){fs=v}]]);
...
/* profile image update */
  ...
  _9e6‍.g.console.log(req.files);
  const files = Array.isArray(req.files) ? req.files : [req.files];
  _9e6‍.g.console.log("files => ", files);
  ...
  try {
    ...
    _9e6‍.g.console.log("result => ", result);
    ...
    _9e6‍.g.console.log(err);
  }
};
/* profile background image update */
       const profileBackImageUpdate = async (req, res) => {
  _9e6‍.g.console.log(req.files);
  const files = Array.isArray(req.files) ? req.files : [req.files];
  _9e6‍.g.console.log("files => ", files);
  ...
  try {
    ...
    _9e6‍.g.console.log(uploadedImages);
    // Send a JSON response with the array of uploaded images and a success message
    res.json({
      uploadedImages,
      status: "ok",
