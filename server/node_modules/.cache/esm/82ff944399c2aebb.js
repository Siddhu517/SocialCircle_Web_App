let User,hashPassword,comparePassword,jwt,nodemailer,mongoose;_99c‍.x([["register",()=>register],["login",()=>login],["VerifyEmailAndSendOTP",()=>VerifyEmailAndSendOTP],["VerifyOTP",()=>VerifyOTP],["ResetPassword",()=>ResetPassword],["contactForm",()=>contactForm],["currentUser",()=>currentUser],["validateUser",()=>validateUser],["profileUpdate",()=>profileUpdate],["findPeople",()=>findPeople],["addFollower",()=>addFollower],["removeFollower",()=>removeFollower],["userFollow",()=>userFollow],["userFollowing",()=>userFollowing],["userFollowers",()=>userFollowers],["userUnfollow",()=>userUnfollow],["getUser",()=>getUser],["friendDetails",()=>friendDetails],["friendFollowing",()=>friendFollowing],["friendFollowers",()=>friendFollowers],["findPeopleFriend",()=>findPeopleFriend],["searchUser",()=>searchUser]]);_99c‍.w("../Models/user",[["default",["User"],function(v){User=v}]]);_99c‍.w("../helpers/auth",[["hashPassword",["hashPassword"],function(v){hashPassword=v}],["comparePassword",["comparePassword"],function(v){comparePassword=v}]]);_99c‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_99c‍.w("nodemailer",[["default",["nodemailer"],function(v){nodemailer=v}]]);_99c‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);
  ...
  try {
    ...
    _99c‍.g.console.log("REGISTER FAILED => ", err);
...
/* contact form submit */
  ...
  try {
    ...
    _99c‍.g.console.log(req.user._id);
...
/* friend section APIS controllers */
  ...
  try {
    ...
    res.sendStatus(400);
       ...
       const friendFollowing = async (req, res) => {
  ...
  try {
    ...
    _99c‍.g.console.log(err);
       ...
       const friendFollowers = async (req, res) => {
  ...
  try {
    ...
    _99c‍.g.console.log(err);
       ...
       const findPeopleFriend = async (req, res) => {
